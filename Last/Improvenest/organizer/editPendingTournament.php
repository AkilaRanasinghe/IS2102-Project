...
<script>
	function checkvalues(){
		...
		var b=new Date(document.editTournament.rcDate.value);
		var c=new Date(document.editTournament.sDate.value);
		var d=new Date(document.editTournament.eDate.value);
		var date = new Date();
		if(c < date || b < date || c < b || d < c)
		{
	...
	<div class="column contents">
		<div class="input-form" style="padding:20px 150px 20px 150px;">
			<h1>Edit Tournament</h1>
				<form action="../php/edit_pending_tournament.php" name="editTournament" method="POST" onsubmit="return checkvalues()">
				<?php
                ...
                <tr>
					<td colspan="5">
						<p>Start Date</p>
						<input type="date" placeholder="Sdate" value="<?php echo $startDate ?>" name="sDate"  required >												
					</td>			
					<td colspan="5">
						<p>End Date</p>
						<input type="date" placeholder="Edate" value="<?php echo $endDate ?>" name="eDate" required >							
					</td>
                </tr>
				<tr>
					<td colspan="5">
						<p>Registration Closing Date</p>
						<input type="date" placeholder="RCdate" value="<?php echo $entryClosing ?>" name="rcDate" required >	
					</td>			
					<td colspan="5">
						<p>Venue</p>
                ...
                <tr>
            		<td colspan="5">
						<p>Sport </p>
						<input type="text" placeholder="Venue" value="<?php echo $sport ?>" name="sport" required >			
					</td>		
					<td colspan="5">
						<p>Entry Fee</p>
						<input type="text" placeholder="Address" value="<?php echo $entryFee ?>" name="eFee" required >	
					</td>			
				</tr>
                <tr>		
					<td colspan="5">
				...
				<tr align="center">
					<td colspan="3">
						<button type="submit" id="updatetournamentbtn" value="Submit">Update</button> </a>				
					</td>
					<td colspan="3">
