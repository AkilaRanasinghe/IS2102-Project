		...
		<div class="maintabcontent">		
			<div class="row search-form">
				...
				<div class="column procol5" style="padding-top:25px;">
					<form action="searchpapprovedtournament.php" method="POST">
			...
			<div class="row">
				<?php
                    $sql = "SELECT DISTINCT * FROM tournament WHERE CONCAT (username, '', name, '', max_participants, '', conditions, '', contact_no, '', venue, '', entry_closing_date, '', start_date, '', end_date, '', sport, '', entry_fee, '', rules_regulations) LIKE '%" . $search . "%' AND status='Approved' AND username='$uname' ORDER BY start_date DESC";    
					...
					if($result->num_rows > 0)
					{
						while($row = $result->fetch_assoc())
						{
                            ...
                            $sqli="SELECT * FROM tournament WHERE status='APPROVED' AND username='$uname' ORDER BY start_date DESC";
