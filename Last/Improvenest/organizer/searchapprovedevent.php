...
<div class="row">
	...
	<div class="column contents">
		<div class="row tab">
			<a href="event.php" class="active">Approved</a>
			<a href="eventpending.php">Pending</a>
			<a href="eventrejected.php">Rejected</a>
		...
		<div class="maintabcontent">		
			<div class="row search-form">
				...
				<div class="column procol5" style="padding-top:25px;">
					<form action="searchapprovedevent.php" method="POST">
			...
			<div class="row">
				<?php
					$sql="SELECT * FROM event WHERE status='APPROVED' AND username='$uname' ORDER BY held_date DESC";
                    $sql = "SELECT DISTINCT * FROM event WHERE CONCAT (username, '', name, '', max_participants, '', conditions, '', contact_no, '', venue, '', held_date, '', entry_closing_date, '', start_time, '', end_time, '', expenses_fees, '', event_type) LIKE '%" . $search . "%' AND status='APPROVED' AND username='$uname' ORDER BY held_date DESC";    
					...
					if($result->num_rows > 0)
					{
						while($row = $result->fetch_assoc())
						{
                            ...
                            $sqli="SELECT * FROM event WHERE status='APPROVED' AND username='$uname' ORDER BY held_date DESC";
                            ...
                            if($helddate < $today)
							{
								...
								<a href='viewClosedApprovedEvent.php?id=".$id."'><button type='submit' align='left' style='width:23%; background-color: #F94545; font-family:arial; height: 150px; font-size: 22px; margin: 0; border-radius: 5px 5px 5px 5px;'>View Event</button></a>
						...
						else
						{
							echo"<div class='horitem'>
								...
								<a href='viewApprovedEvent.php?id=".$id."'><button type='submit' align='left' style='width:23%; background-color: #45C5F9; font-family:arial; height: 150px; font-size: 22px; margin: 0; border-radius: 5px 5px 5px 5px;'>View Event</button></a>
								<div class='procol4'></div>
