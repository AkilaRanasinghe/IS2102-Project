...
<div class="row">
	...
	<div class="column contents">
		...
		<div class="maintabcontent">		
			...
			<div class="row">
				<?php
                    $sql = "SELECT DISTINCT * FROM tournament WHERE CONCAT (username, '', name, '', max_participants, '', conditions, '', contact_no, '', venue, '', entry_closing_date, '', start_date, '', end_date, '', sport, '', entry_fee, '', rules_regulations) LIKE '%" . $search . "%' AND status='PENDING' AND username='$uname' ORDER BY start_date DESC";    
					...
					if($result->num_rows > 0)
					{
						while($row = $result->fetch_assoc())
						{
                            ...
                            $sqli="SELECT * FROM tournament WHERE status='PENDING' AND username='$uname' ORDER BY start_date DESC";
