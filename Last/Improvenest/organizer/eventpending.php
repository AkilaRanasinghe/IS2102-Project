...
<div class="row">
	...
	<div class="column contents">
		...
		<div class="maintabcontent">		
			...
			<div class="row">
				<?php
					$sql="SELECT * FROM event WHERE status='PENDING' AND username='$uname' ORDER BY held_date DESC";
					...
					if($result->num_rows > 0)
					{
						while($row = $result->fetch_assoc())
						{
							...
							if($helddate < $today)
							{
								...
								<a href='viewClosedPendingEvent.php?id=".$id."'><button type='submit' align='left' style='width:23%; font-family:arial; background-color: #F94545; height: 150px; font-size: 22px; margin: 0; border-radius: 5px 5px 5px 5px;'>View Event</button></a>
				...
				{
					echo "<div class='procol7'><h3>No Approved Events.</h3></div>";
				}
				$conn->close();
				?>		
			</div>	
