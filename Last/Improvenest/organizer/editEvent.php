...
<div class="row">
	...
	<div class="column contents">
		<div class="input-form" style="padding:20px 150px 20px 150px;">
			<h1>Edit Event</h1>
				<form action="../php/edit_event.php" name="editTournament" method="POST">
				<?php
				...
				<tr>
					...
					<td colspan="5">
						<p>Event Focus</p>
						<input type="text" placeholder="Event Focus" value="<?php echo $event_type ?>" name="event_type" required disabled>				
					</td>			
				</tr>
                <tr>
					<td colspan="5">
				...
				<tr>
					...
					<td colspan="5">
						<p>Entry Fee</p>
						<input type="text" placeholder="Entry Fee" value="<?php echo $expenses_fees ?>" name="expenses_fees" required disabled>	
					</td>			
				</tr>
                <tr>
            		<td colspan="5">
						<p>Entry Closing Date </p>
						<input type="date" placeholder="Entry Closing Date" value="<?php echo $entry_closing_date ?>" name="entry_closing_date" required disabled>			
					</td>		
					<td colspan="5">
						<p>Held Date</p>
						<input type="date" placeholder="Held  Date" value="<?php echo $held_date ?>" name="held_date" required disabled>	
					</td>			
				</tr>
                <tr>		
					<td colspan="5">
						<p>Start Time</p>
						<input type="time" placeholder="Start Time" value="<?php echo $start_time ?>" name="start_time" required  disabled>	
					</td>			
				</tr>
                <tr>		
					<td colspan="5">
						<p>End Time</p>
						<input type="time" placeholder="End Time" value="<?php echo $end_time ?>" name="end_time" required disabled>	
					</td>			
				</tr>
                <tr>
                    <td colspan="10">
