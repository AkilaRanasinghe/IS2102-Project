...
<div class="row">
	...
	<div class="column contents">
		<div class="row tab">
			...
			<a href="tournamentrejected.php" class="active">Rejected</a>
		...
		<div class="maintabcontent">		
			<div class="row search-form">
				...
				<div class="column procol5" style="padding-top:25px;">
					<form action="searchrejectedctournament.php" method="POST">
			...
			<div class="row">
				<?php
                    $sql = "SELECT DISTINCT * FROM tournament WHERE CONCAT (username, '', name, '', max_participants, '', conditions, '', contact_no, '', venue, '', entry_closing_date, '', start_date, '', end_date, '', sport, '', entry_fee, '', rules_regulations) LIKE '%" . $search . "%' AND status='rejected' AND username='$uname' ORDER BY start_date DESC";    
					...
					if($result->num_rows > 0)
					{
						while($row = $result->fetch_assoc())
						{
                            ...
                            $sqli="SELECT * FROM tournament WHERE status='rejected' AND username='$uname' ORDER BY start_date DESC";
							...
							if($helddate < $today)
							{
								...
								<a href='viewRejectedTournament.php?id=".$id."'><button type='submit' align='left' style='width:23%; background-color: #F94545; font-family:arial; height: 150px; font-size: 22px; margin: 0; border-radius: 5px 5px 5px 5px;'>View Tournament</button></a>
						...
						else
						{
							echo"<div class='horitem'>
									...
									echo"</div>
									<br /> <br /><br /><br />
									<a href='viewRejectedTournament.php?id=".$id."'><button type='submit' align='left' style='width:23%; background-color: #45C5F9; font-family:arial; height: 150px; font-size: 22px; margin: 0; border-radius: 5px 5px 5px 5px;'>View Tournament</button></a>
