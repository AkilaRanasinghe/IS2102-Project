		...
		<div class="maintabcontent">		
			<div class="row search-form">
				...
				<div class="column procol5" style="padding-top:25px;">
					<form action="searchrejectedtournament.php" method="POST">
			...
			<div class="row">
				<?php
					$sql="SELECT * FROM tournament WHERE status='rejected' AND username='$uname' ORDER BY start_date DESC";
				...
				{
					echo "<div class='procol7'><h3>No Rejected Tournaments.</h3></div>";
				}
				$conn->close();
				?>		
			</div>	
