	...
	<div class="column contents">	
		<div class="input-form" style="padding:20px 150px 20px 150px;">
			...
			<form method="post" action="https://sandbox.payhere.lk/pay/checkout">
				...
				<input type="hidden" name="return_url" value="http://localhost/Improvenest/php/finalizedplayertournament.php">
				...
				<fieldset>
					...
					<table cellspacing="2" cellpadding="2" border="0" >
						...
						<tr>
							<td colspan="5">
								<p>Start Date</p>
								<input type="text" value="<?php echo $sdate ?>" readonly>		
							</td>
							<td colspan="5">
								<p>End Date</p>
								<input type="text" value="<?php echo $edate ?>" readonly>	
							</td>			
						</tr>
						<tr>
							<td colspan="10">
