		...
		<div class="maintabcontent">
			...
			<div class='row'>
				<div id="Updates" class="tabcontent">
					<div class="row">
						<?php
						$sql="SELECT DISTINCT nw.news_id, nw.title, nw.content, nw.added_date, nw.image FROM news nw, news_sport nsp where nw.news_id = nsp.news_id AND (nsp.sport = 'All' OR nsp.sport IN (SELECT sport FROM player_sport WHERE username = '" .$uname. "')) AND nw.Category = 'Updates' ORDER BY nw.added_date DESC";
