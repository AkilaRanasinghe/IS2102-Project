					...
					<div class='column procol1'>
						...
						<div class='row'>
							<div class='accept half' style='float:left;'>
								<a href='../php/acceptplayer.php?id=".$id."'><button style='cursor: pointer;font-family: arial;border: none;outline: 0;padding: 12px;width: 97%;font-size: 14px;margin-top: 30px;'>Accept</button></a>
							</div>
							<div class='decline half' style='float:right'>
								<a href='../php/removeplayer.php?id=".$id."'><button style='cursor: pointer;font-family: arial;border: none;outline: 0;padding: 12px;width: 97%;font-size: 14px;margin-top: 30px;'>Decline</button></a>
							</div>							
						</div>					
					</div>
