...
<div class="row">
	...
	<div class="column contents">
		...
		$sqli="SELECT * FROM (SELECT occasion_id, username, name, venue, occasion_type FROM event UNION SELECT occasion_id, username, name, venue, occasion_type FROM tournament) a WHERE occasion_id = '" .$id. "'";
		...
		if($resulti->num_rows > 0)
		{
			while($rowi = $resulti->fetch_assoc())
			{
				...
				if($type == "Tournament")
				{
					$sql = "SELECT * FROM (SELECT username, name AS 'Oname', user_type FROM organiser UNION SELECT username, name AS 'Oname', user_type FROM federation) a, tournament t WHERE a.username = t.username AND t.occasion_id = '".$id."'";
								...
								<div class='procol5'>
									...
									<div class='form-popup' id='myForm'>
										<form action='../php/reporttournament.php' class='popup-container' method='POST'>
											...
											<input type='hidden' name='type' value='echo $type ' style='padding: 10px;'>
								...
								<div class='procol4'>
									<div class='row'>
										<div class='accept half' style='float:left;'>
											<a style='padding:0px;' href='../php/unregistersession.php?id=".$id."'><button style='height:80px;'>Unregister</button></a>
										</div>
				...
				{
					$sql = "SELECT * FROM (SELECT username, CONCAT(f_name, ' ', l_name) AS 'Oname', user_type FROM player UNION SELECT username, CONCAT(f_name, ' ', l_name) AS 'Oname', user_type FROM coach UNION SELECT username, name AS 'Oname', user_type FROM organiser UNION SELECT username, name AS 'Oname', user_type FROM federation) a, event e WHERE a.username = e.username AND e.occasion_id = '".$id."'";
						...
						{		
							echo"<div class='row' style='padding:30px;'>
								<div class='procol5'>
									...
									<div class='form-popup' id='myForm'>
										<form action='../php/reportjoinedsession.php' class='popup-container' method='POST'>
											<h2 style='text-align:center;'>Make Complain</h2>
											...
											<input type='hidden' name='acctype' value='echo $type ' style='padding: 10px;'>
											<input type='text' name='complaint' placeholder='Complaint' style='padding: 10px;' required>
								...
								<table class='protable' cellspacing='2' cellpadding='2' border='0' width='100%'>						
									...
									<tr>
										...
										<td>
											...
											<td>";
												$sqlll = "SELECT * FROM event_sport WHERE occasion_id = '".$id."'";
									...
									<tr>
										...
										<td>
											...
											<td>";
												$sqlli = "SELECT * FROM event_aspect WHERE occasion_id = '".$id."'";
