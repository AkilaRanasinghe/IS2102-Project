			...
			{		
				echo"<div class='row'>
					<div class='column procol1'>
						...
						<a href='../php/removeplayer.php?id=".$id."'><button id='hoverbtn' style='cursor: pointer;font-family: arial;border: none;outline: 0;padding: 12px;width: 97%;font-size: 14px;margin-top: 30px;'>Undo Request</button></a>
					</div>
