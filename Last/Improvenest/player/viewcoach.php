			...
			if($result->num_rows > 0)
			{
				...
				{		
					echo"<div class='column procol1'>
						...
						echo"<a href='../php/requestcoach.php?id=".$id."'><button id='hoverbtn' style='cursor: pointer;font-family: arial;border: none;outline: 0;padding: 12px;width: 97%;font-size: 14px;margin: 0;'>Send Request</button></a></div>
