	...
	<div class="column contents">
		...
		<div class="input-form" style="padding:20px 150px 20px 150px;">
			...
			<form method="post" action="https://sandbox.payhere.lk/pay/checkout">
				...
				?>
				<input type="hidden" name="merchant_id" value="1218919">
				<input type="hidden" name="return_url" value="http://localhost/Improvenest/php/notify.php">
				<input type="hidden" name="cancel_url" value="http://localhost/Improvenest/player/shops.php">
