...
$sql = "UPDATE event SET name='$name', max_participants='$max_participants', conditions='$conditions', contact_no='$contact_no', venue='$venue' where occasion_id = $id";

if (mysqli_query($conn, $sql)) {
	// echo "New record successfully";
	echo '<script> alert("Success!");</script>';
	echo '<script> location.href="../organizer/viewApprovedEvent.php"</script>';
  } else {
