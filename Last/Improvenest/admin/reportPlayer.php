				...
				<table width="100%" cellpadding="10px" border="1" style="border-collapse: collapse; ">
		    		...
		    		<tbody>
						<?php
							...
							$sql_query = "SELECT * FROM report WHERE type='Player' AND status='delete' ORDER BY report_id";
								...
								<tr class="raw"> 
									<div class="row">
										<div class="horitem">
											...
											<div class="procol4">
											<br /><br />
											<a href="deleteplayer.php?reported_username=<?php echo $row["reported_username"]; ?>"><button style="background-color: #ED5F5F;">Delete User</button></a>
											</div>				
										</div>
									</div>	
									<br/>
