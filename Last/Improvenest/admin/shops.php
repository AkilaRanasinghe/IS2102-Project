	...
	<div class="column contents">
		<div class="row search-form">
			<div class="column procol4">
				<a href="addshop.php"><button style="width:100%; height:60px; background-color: #50AEC4;"> Add Shop </button></a>
			</div>
					...
					if($resultt->num_rows > 0)
					{
						while($roww = $resultt->fetch_assoc())
						{
							echo"<div class='shopitem'>
									...
									$sqlll = "SELECT sport FROM shop_sport WHERE sport IN (SELECT sport FROM player_sport WHERE username = '" .$uname. "') AND shop_id = '".$shopid."'";
									...
									if($resulttt->num_rows > 0)
									{
										...
										echo"<small>Related Sports&emsp;:&emsp;</small>";
										for($x = 0 ; $x < count($data) ; $x++)
										{
											echo"<small>".$data[$x]."&emsp;</small>";
										}
									}
								echo"</div>";
						}							
