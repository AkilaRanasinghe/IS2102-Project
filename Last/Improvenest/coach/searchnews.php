	...
	<div class="column contents">
		...
		<div class="maintabcontent">
			<div class="row tab" style="padding-left:0px;">
				<a class="buttonlinks" onclick="openUser(event, 'Updates')" id="defaultOpen" style="width:50%;">Spoerts Updates</a>
				<a class="buttonlinks" onclick="openUser(event, 'Tips')" style="width:50%;">Improvement Tips</a>
			</div>
			<?php
			$search = "";
			$sort ="";
