...
<div class="row">
	...
	<div class="column contents">
				...
				echo"<div class='row'>
					<div class='column procol1'>
						...
						<div class='form-popup' id='myForm'>
							<form action='../php/coachreportplayer.php' class='popup-container' method='POST'>
		...
		<div class="row" style="padding:10px 10px 0px 10px;" align="center">
			...
			<div class="column common">
				<?php echo"<a href='../php/removeplayerbycoach.php?id=".$id."'><button style='background-color:#a32626;'>Remove</button></a>";?>
			</div>
		</div>			
	</div>
	<!-----------CONTENTS END-------------->
